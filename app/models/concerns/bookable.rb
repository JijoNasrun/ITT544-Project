module Bookable
  ...
  def overlaps
    overlapping_bookings = [ 
      book.bookings.end_during(start_time, end_time),
      book.bookings.start_during(start_time, end_time),
      book.bookings.happening_during(start_time, end_time),
      book.bookings.enveloping(start_time, end_time),
      book.bookings.identical(start_time, end_time)
    ].flatten
